...
namespace App\Controllers\Api\SatuSehat\Specimen;

use App\Services\SatusehatService;

abstract class SpecimenBase
{
    protected $service;
    ...
    protected function sendFHIRSpecimen($payload)
    {
        try {
            $response = $this->service->post('Specimen', $payload);
