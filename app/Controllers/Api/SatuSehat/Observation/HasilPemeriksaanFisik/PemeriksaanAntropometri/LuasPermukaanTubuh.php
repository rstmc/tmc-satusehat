...
class LuasPermukaanTubuh extends ObservationBase
{
    public function push($row, $encounterId)
    {
        // Pastikan nilai Luas Permukaan Tubuh ada
        if (empty($row['LuasPermukaanTubuh'])) {
            return null;
        }
        ...
        $payload = [
            ...
            "valueQuantity" => [
                "value" => (float)$row['LuasPermukaanTubuh'],
                "unit" => "m2",
