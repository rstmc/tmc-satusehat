...
class ImunisasiKhusus extends ImmunizationBase
{
            ...
            "vaccineCode" => [
                "coding" => [
                    [
                        ...
                        "code" => $row['VaccineCodeKFA'] ?? 'VG90',
                        "display" => $row['VaccineDisplayKFA'] ?? 'RABIES'
                    ]
                ]
            ],
            "patient" => [
                ...
                [
                    "coding" => [
                        [
                            ...
                            "code" => $row['ReasonCode'] ?? 'IM-Khusus',
                            "display" => $row['ReasonDisplay'] ?? 'Imunisasi Program Khusus'
                        ]
                    ]
                ]
            ],
