...
class ImunisasiPilihan extends ImmunizationBase
{
            ...
            "vaccineCode" => [
                "coding" => [
                    [
                        ...
                        "code" => $row['VaccineCodeKFA'] ?? 'VG122',
                        "display" => $row['VaccineDisplayKFA'] ?? 'ROTAVIRUS'
                    ]
                ]
            ],
            "patient" => [
                ...
                [
                    "coding" => [
                        [
                            ...
                            "code" => $row['ReasonCode'] ?? 'IM-Pilihan',
                            "display" => $row['ReasonDisplay'] ?? 'Imunisasi Pilihan'
                        ]
                    ]
                ]
            ],
