...
class SelfReportingbyPatient extends ImmunizationBase
{
            ...
            "vaccineCode" => [
                "coding" => [
                    [
                        ...
                        "code" => $row['VaccineCodeKFA'] ?? 'VG89',
                        "display" => $row['VaccineDisplayKFA'] ?? 'POLIO'
                    ],
                    [
                        "system" => "http://hl7.org/fhir/sid/cvx",
                        "code" => $row['VaccineCodeCVX'] ?? '10',
                        "display" => $row['VaccineDisplayCVX'] ?? 'IPV'
                    ]
                ]
            ],
            "patient" => [
